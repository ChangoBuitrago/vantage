...
**The Model:** Physical assets are sold anywhere. When ownership changes, the reseller pays an Exit Tax (royalty) to transfer the digital passport (NFT) to the new owner. Payment and settlement happen automatically—no collector approval required.
...
- **Exit Tax Model:** Current owner pays royalty via Stripe to unlock immediate NFT transfer
- **Trust-Based:** Reseller declares sale price; transfer executes immediately after payment
...
- **Stripe Integration:** Processes immediate payment for reseller exit tax
- **Compliance Gate:** Validates payment and generates cryptographic permit
- **Permit:** ECDSA signature proving exit tax was paid
