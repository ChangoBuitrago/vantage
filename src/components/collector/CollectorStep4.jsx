...
export default function CollectorStep3({ setCurrentStep }) {
  ...
  // Passport data
  // John's demo: "today" is real today (showing locked state - just received!)
  ...
  // John received transfer today: 10 Nov 2025
  const transferDate = new Date();
  const transferTimestamp = transferDate.getTime();
  
  // John's transfer lock ends 10 May 2026 (6 months after his purchase, full 6 months remaining)
    ...
    <div className="px-6 py-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-600 dark:text-gray-400 mt-2">Verified ownership with rule-enforced protection and lifetime benefits</p>
        </div>
                    ...
                    <div className="px-4 pb-4 border-t border-gray-200 dark:border-gray-700 bg-slate-50 dark:bg-slate-900/50">
                      <div className="pt-3 space-y-2">
                        ...
                        <div className="flex items-center gap-3 p-2.5 bg-white dark:bg-slate-800 rounded-lg border border-gray-200 dark:border-gray-700">
                          ...
                          <div className="flex-1 min-w-0">
                            <p className="text-sm font-semibold text-gray-900 dark:text-white">Service Log</p>
                            <p className="text-xs text-gray-500 dark:text-gray-400">Verified maintenance history</p>
                          </div>
                        </div>
                      </div>
                    </div>
