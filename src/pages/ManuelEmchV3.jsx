...
import { ArrowRight, Shield, TrendingUp, Users, Heart, Sparkles, Target, Percent, Clock, CheckCircle, X } from 'lucide-react';

export default function ManuelEmchV3() {
  ...
  return (
    <>
      ...
      <div ref={containerRef} className="smooth-scroll-container h-screen overflow-y-scroll snap-y snap-mandatory scroll-smooth [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
          ...
          <div className="w-full max-w-4xl mx-auto z-10 text-center">
            <div className="mb-12">
              ...
              <p className="text-3xl md:text-4xl text-gray-700 dark:text-gray-300 mb-12 font-light leading-relaxed max-w-3xl mx-auto">
                What if every watch you create could generate perpetual revenue while protecting your values?
              </p>
            </div>
            ...
            <div className="bg-white/90 dark:bg-slate-900/90 backdrop-blur-sm rounded-3xl p-10 border border-amber-200 dark:border-amber-800 shadow-xl max-w-2xl mx-auto">
              ...
              <p className="text-2xl font-bold text-gray-900 dark:text-white leading-relaxed pt-6 border-t border-amber-200 dark:border-amber-800">
                What if there was a way to maintain your values—and generate revenue—throughout a watch's entire lifetime?
              </p>
            </div>
          </div>
        </section>
        ...
        {/* --- SECTION 3: THE FUNDAMENTAL SHIFT --- */}
        <section className="h-screen snap-start snap-always flex flex-col items-center justify-center p-8 bg-gradient-to-br from-slate-50 via-white to-slate-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 relative overflow-hidden">
          <div className="w-full max-w-5xl mx-auto z-10">
            <div className="text-center mb-12">
              <p className="text-sm text-gray-500 dark:text-gray-400 mb-4 uppercase tracking-wider font-semibold">The Shift</p>
              <h2 className="text-4xl md:text-5xl font-black tracking-tight text-gray-900 dark:text-white mb-4">
                Revenue Infrastructure, Not Tracking Technology
              </h2>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-12">
              ...
              <div className="bg-red-50 dark:bg-red-900/20 rounded-2xl p-8 border-2 border-red-200 dark:border-red-800">
                <div className="flex items-center gap-2 mb-6">
                  ...
                  <p className="text-sm font-semibold text-red-700 dark:text-red-300 uppercase">Old View: DPP</p>
                </div>
                <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-4">Cost Center</h3>
                <ul className="space-y-3 text-gray-700 dark:text-gray-300">
                  <li className="flex items-start gap-2">
                    <span className="text-red-600 dark:text-red-400">•</span>
                    <span>"We track the watch's history for customer service"</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-red-600 dark:text-red-400">•</span>
                    <span>Bureaucratic tool (like Breitling/Arianee)</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-red-600 dark:text-red-400">•</span>
                    <span>Expense with no revenue return</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-green-50 dark:bg-green-900/20 rounded-2xl p-8 border-2 border-green-200 dark:border-green-800">
                <div className="flex items-center gap-2 mb-6">
                  <CheckCircle className="w-5 h-5 text-green-600 dark:text-green-400" />
                  <p className="text-sm font-semibold text-green-700 dark:text-green-300 uppercase">New View: Smart Certificate</p>
                </div>
                <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-4">Profit Center</h3>
                <ul className="space-y-3 text-gray-700 dark:text-gray-300">
                  <li className="flex items-start gap-2">
                    <span className="text-green-600 dark:text-green-400">•</span>
                    <span>"We attach a digital certificate with programmable rules that generate perpetual revenue"</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-green-600 dark:text-green-400">•</span>
                    <span>Revenue-enabled certificate structure</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-green-600 dark:text-green-400">•</span>
                    <span>Revenue from every resale, automatically</span>
                  </li>
                </ul>
              </div>
            </div>

            <div className="bg-amber-50 dark:bg-amber-900/30 rounded-2xl p-8 border-2 border-amber-300 dark:border-amber-700">
              <p className="text-center text-lg font-semibold text-amber-900 dark:text-amber-100 mb-4">
                We are no longer pitching "Digital Product Passports" or tracking technology.
              </p>
              <p className="text-center text-gray-700 dark:text-gray-300">
                We are pitching the transformation of a watch from a static consumer product into a <span className="font-bold text-amber-900 dark:text-amber-100">perpetual revenue generator</span> through programmable rules.
              </p>
            </div>
          </div>
        </section>

        {/* --- SECTION 4: THE SMART CERTIFICATE --- */}
        <section className="h-screen snap-start snap-always flex flex-col items-center justify-center p-8 bg-gradient-to-br from-amber-50 via-orange-50 to-amber-50 dark:from-amber-950/30 dark:via-orange-950/30 dark:to-amber-950/30 relative overflow-hidden">
          <div className="w-full max-w-5xl mx-auto z-10">
            <div className="text-center mb-12">
              ...
              <h2 className="text-4xl md:text-5xl font-black tracking-tight text-gray-900 dark:text-white mb-4">
                Smart Certificate: Revenue Through Programmable Rules
              </h2>
              <p className="text-xl text-gray-700 dark:text-gray-300 max-w-3xl mx-auto">
                Not a tracking tool. A digital certificate with programmable rules that generate perpetual revenue.
              </p>
            </div>

            {/* Dual Structure Visual */}
            <div className="bg-white dark:bg-slate-900 rounded-3xl p-10 border-2 border-amber-300 dark:border-amber-700 shadow-2xl mb-10">
              <div className="grid md:grid-cols-2 gap-8 mb-8">
                <div className="text-center p-6 bg-slate-50 dark:bg-slate-800 rounded-xl">
                  ...
                  <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">The Watch</h3>
                  <p className="text-gray-600 dark:text-gray-400">Physical object. Utility. Enjoyment.</p>
                </div>
                <div className="text-center p-6 bg-amber-50 dark:bg-amber-900/30 rounded-xl border-2 border-amber-300 dark:border-amber-700">
                  <div className="w-20 h-20 bg-amber-200 dark:bg-amber-800 rounded-full flex items-center justify-center mx-auto mb-4">
                    <Shield className="w-10 h-10 text-amber-700 dark:text-amber-300" />
                  </div>
                  <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">The Smart Certificate</h3>
                  <p className="text-gray-600 dark:text-gray-400">Digital proof. Provenance. Programmable rules.</p>
                </div>
              </div>

              <div className="bg-amber-50 dark:bg-amber-900/30 rounded-xl p-6 border-2 border-amber-300 dark:border-amber-700">
                <p className="text-center font-semibold text-amber-900 dark:text-amber-100 mb-4">
                  The Mechanism: The watch cannot command its full secondary market premium without the Certificate
                </p>
                <p className="text-sm text-amber-700 dark:text-amber-400 text-center">
                  Buyers demand the Certificate for authenticity verification. This dependency enforces the rules automatically.
                </p>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-8">
              <div className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm rounded-xl p-6 border-2 border-amber-200 dark:border-amber-800">
                ...
                <h3 className="font-bold text-gray-900 dark:text-white mb-2 text-center">Smart Rules (Control)</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400 text-center">
                  Programmable controls: Transfer Lock (6-month minimum ownership) eliminates immediate flipping
                </p>
              </div>
              <div className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm rounded-xl p-6 border-2 border-amber-200 dark:border-amber-800">
                <div className="w-12 h-12 bg-amber-100 dark:bg-amber-900/50 rounded-full flex items-center justify-center mx-auto mb-4">
                ...
                <h3 className="font-bold text-gray-900 dark:text-white mb-2 text-center">Dynamic Royalties (Revenue)</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400 text-center">
                  Automatic revenue sharing: 90% Year 1 (deter speculators), 15% Year 3+ (reward brand)
                </p>
              </div>
            </div>

            {/* Revenue Flow */}
            <div className="bg-white dark:bg-slate-900 rounded-3xl p-10 border-2 border-amber-300 dark:border-amber-700 shadow-2xl">
              <div className="flex items-center justify-center gap-3 mb-8">
                <Shield className="w-7 h-7 text-amber-600 dark:text-amber-400" />
                <span className="text-xl font-bold text-amber-700 dark:text-amber-400">With Smart Certificate</span>
              </div>
        ...
        {/* --- SECTION 5: THE REVENUE INFRASTRUCTURE --- */}
        <section className="h-screen snap-start snap-always flex flex-col items-center justify-center p-8 bg-gradient-to-br from-slate-50 via-white to-slate-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 relative overflow-hidden">
          <div className="w-full max-w-4xl mx-auto z-10">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-700 dark:text-gray-300 max-w-3xl mx-auto">
                Just as you use Selitta movements—reliable, invisible engines—Faircut is the reliable, invisible revenue engine
              </p>
            </div>

            <div className="bg-white dark:bg-slate-900 rounded-3xl p-10 border-2 border-amber-300 dark:border-amber-700 shadow-2xl mb-8">
              <div className="grid md:grid-cols-2 gap-8 items-center">
                <div>
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">Selitta Movement</h3>
                  <p className="text-gray-700 dark:text-gray-300 mb-4">
                    Reliable. Invisible. Powers the watch. You don't build movements; you use the best.
                  </p>
                </div>
                <div className="text-center">
                  <ArrowRight className="w-12 h-12 text-amber-600 dark:text-amber-400 mx-auto mb-4" />
                </div>
                <div>
                  <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">Faircut Revenue Infrastructure</h3>
                  <p className="text-gray-700 dark:text-gray-300 mb-4">
                    Reliable. Invisible. Powers the revenue stream. You don't build payment systems; you use the best.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-amber-50 dark:bg-amber-900/30 rounded-2xl p-8 border-2 border-amber-300 dark:border-amber-700">
              <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-4 text-center">Independence & Revenue</h3>
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <p className="text-sm font-semibold text-red-700 dark:text-red-300 mb-2">Breitling/Arianee Approach</p>
                  <ul className="text-sm text-gray-600 dark:text-gray-400 space-y-1">
                    <li>• Service & Buy-Backs</li>
                    <li>• Capital Heavy (must buy inventory)</li>
                    <li>• $0 from peer-to-peer trades</li>
                  </ul>
                </div>
                <div>
                  <p className="text-sm font-semibold text-green-700 dark:text-green-300 mb-2">Faircut Approach</p>
                  <ul className="text-sm text-gray-600 dark:text-gray-400 space-y-1">
                    <li>• Independence & Revenue</li>
                    <li>• Capital Light (no buy-backs needed)</li>
                    <li>• Revenue from open market (Chrono24, etc.)</li>
                  </ul>
                </div>
              </div>
            </div>
        ...
        {/* --- SECTION 6: INDEPENDENCE & SELF-SUSTAINABILITY --- */}
          ...
          <div className="w-full max-w-4xl mx-auto z-10">
            <div className="text-center mb-8">
              <h2 className="text-3xl md:text-4xl font-black tracking-tight text-gray-900 dark:text-white mb-3">
                Independence & Self-Sustainability
              </h2>
              <p className="text-lg text-gray-600 dark:text-gray-400">
                Convert "lost" market markup into a perpetual revenue stream—your war chest for future creativity
              </p>
            </div>

            {/* Values Alignment */}
            <div className="bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-950/30 dark:to-orange-950/30 rounded-2xl p-8 border-2 border-amber-300 dark:border-amber-700 shadow-xl mb-8">
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 dark:text-gray-300 leading-relaxed text-base">
                      You prioritize design, art, and authentic value over marketing noise. Smart certificates enable this by rewarding genuine collectors and eliminating flipper margins—your strategy, enforced automatically.
                    </p>
                  </div>
                </div>
            ...
            <div className="text-center">
              ...
              <p className="text-base text-gray-600 dark:text-gray-400 mb-6">
                Smart certificates aren't just technology—they're a way to ensure your values outlive every watch you create.
              </p>
              <p className="text-lg font-semibold text-amber-700 dark:text-amber-400">
                We aren't building a stock market or a CRM. We are creating a revenue infrastructure that ensures the creator gets paid every time the asset changes hands.
              </p>
            </div>
          </div>
        </section>
